...
\section{Experience}
\cventry{since 08.2017}{Backend developer}{FindHotel.net}{Remote}{}{I am responsible for creating low latency, horizontally scalable Golang backend service. My project aggregates information about prices and availabilty for all hotels around the world. We serve about 20 thousand requests per second with latency below 100 ms at p95. It needs to be resilient to unreliable sources of information and optimized for the best user experience. I was one of main developers in this project from the very beginning. Recently I become team leader of the whole project and I am responsible for helping engineers move project forward without frictions.}
