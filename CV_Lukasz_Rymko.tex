...
I am a passionate engineer. I enjoy solving difficult problems and build things. My interests are centred around building scalable web services. I am responsible for creating backend solutions that are secure, scalable and work reliably. In the last four years I focused my personal interests around Golang as I finally found the right tool for the job. Previously I used to switch between different programming languages like Python, Java, Node.JS and C\#.  While creating backends I learned a lot about automating infrastructure management, continuous integration and delivery. I can jump into Ansible and Terraform scripts without any delay. I am mostly experienced with AWS, but Google Cloud is not new to me. I was technical team leader in three different projects throughout three years. I enjoy helping others and I know how to make team work well together. In my spare time I build things with my RaspberryPIs or Arduino and occasionally write code that just solves my day-to-day problems. 

\section{Experience}
\cventry{since 08.2017}{Backend developer}{FindHotel.net}{Remote}{}{I am responsible for creating low latency, horizontally scalable Golang backend service. My project aggregates information about prices and availabilty for all hotels around the world. We serve about 20 thousand requests per second with latency below 100 ms at p95. It needs to be resilient to unreliable sources of information and optimized for the best user experience while maintaining low cost. I was one of main developers in this project from the very beginning. I was making crucial decisions about architecture and to this day I know the most about the project in the company. }
